    ...
    >
      <div className="max-w-5xl mx-auto text-center">
        ...
        <h1 className="text-3xl md:text-4xl font-bold text-white mb-3" style={{ fontFamily: "system-ui, sans-serif" }}>
          Tax &amp; Accounting Firm Website
        </h1>
        <p className="text-white/70 text-base md:text-lg max-w-2xl mx-auto mb-2">
          A professional website platform with appointment booking and client-focused service presentation.
        </p>
        <p className="text-amber-400/80 text-xs">
          Concept demonstration created by Bare Force One to illustrate a modern tax and accounting firm platform.
        </p>
      </div>
    </div>
  );
