/**
 * COMPONENT: BFOBanner
 * Purpose: Concept demo disclaimer banner shown at top of all permit portal pages
 */
...
export default function BFOBanner() {
  ...
  return (
    <div
      ...
      className="relative z-[70] flex items-center justify-center gap-3 px-6 py-3 text-center"
      style={{ backgroundColor: "#0f2744", borderBottom: "1px solid rgba(255,255,255,0.1)" }}
    >
      <p className="text-white/80 text-xs leading-relaxed" style={{ fontFamily: "'IBM Plex Sans', sans-serif" }}>
        <span className="text-amber-400 font-semibold">Concept Demonstration</span>
        {" — "}
        This interface was created by{" "}
        <a
          href="https://bareforceone.com"
          target="_blank"
